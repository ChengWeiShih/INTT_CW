...
void run64_MC_comp()
{
    ...
    // note : //////////// //////////// //////////// //////////// //////////// for data //////////// //////////// //////////// //////////// ////////////
    TString folder_direction_data = "/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/Beamtest_data_Different_config/MC_run64_with_lead_plate_with_ZeroSlope_and_Run64U10offset";
    TString cluster_file_name_data = "cluster_information_offset-0.0000_adcinfo_SingleTrigger";
    int study_chip_data = 10;

    double amount_of_alignment_data = -2.68781e-01; // note : should be zero, because the ladder correction was already performed 
    double slope_correction_data = 0.; // note : test

    // double amount_of_alignment_data = 0; // note : test
    // double slope_correction_data = 0.; // note : test

    data_process * data_class = new data_process(2, "data_class", folder_direction_data, cluster_file_name_data, study_chip_data, amount_of_alignment_data, slope_correction_data);
    ...
    // note : for MC comp
    TString plot_name = "run64_MC_comp_track_extrapolation_pos_RoughTrigger_1";

    vector<TString> titles_vec = {"Track pos @ sci. location [mm]","A.U."};

    TString MC_comp_temp_direction = "/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/Beamtest_data_Different_config";

    vector<TH1F*> MC_hist_array = {Ntrack_extrapolation_pos_dist_data, Ntrack_extrapolation_pos_dist_MC};     
    vector<TString>hist_color_array = {"#1A3947", "#A08144"}; 
    vector<TString>Legend_array = {"MCv1", "MCv2"}; 
