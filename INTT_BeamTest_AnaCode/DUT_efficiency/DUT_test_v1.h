...
void output_SU_root_file (vector<vector<double>>input_2D_vec, TString folder_direction, int run_scan)
{
    cout<<"======================= making the root file ======================="<<endl;
    sleep(2);

    TFile * output_file = new TFile(Form("%s/DUT_v2_cut_scan_%i.root",folder_direction.Data(),run_scan), "RECREATE");
    output_file -> cd();
