...
void print_each_SU( TString folder_direction, double golden_effi, double residual_scan[2], double slope_scan[2], double edge_scan[2] )
{
    cout<<"SU for residual : "<<endl;
    SU_out_str residual_str = cut_scan_calculate("DUT_v2_cut_scan_1",folder_direction,1,residual_scan[0],residual_scan[1]); // note : residual
    cout<<"avg - golden : "<<residual_str.average - golden_effi<<endl;
    cout<<" "<<endl;
    cout<<" "<<endl;

    cout<<"SU for slope : "<<endl;
    SU_out_str slope_str = cut_scan_calculate("DUT_v2_cut_scan_2",folder_direction,2,slope_scan[0],slope_scan[1]); // note : slope
    ...
    cout<<"SU for edge_exclusion : "<<endl;
    SU_out_str edge_str = cut_scan_calculate("DUT_v2_cut_scan_3",folder_direction,3,edge_scan[0],edge_scan[1]); // note : edge_exclusion
