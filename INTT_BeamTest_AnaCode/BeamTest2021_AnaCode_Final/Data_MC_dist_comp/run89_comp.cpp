...
void run89_comp()
{
    ...
    // double extrapol_pos_cut_low  = -15;
    // double extrapol_pos_cut_high = 15;
    ...
    // note : //////////// //////////// //////////// //////////// //////////// for data //////////// //////////// //////////// //////////// ////////////
    TString folder_direction_data = "/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/Beamtest_data_Different_config/data_run89_reference_of_run64/folder_run89_no_clone_filter_all_int_1000_chip_9";
    ...
    double slope_correction_data = 4.74917e-03; // note : data run89 U10
    ...
    // Characterize_Hist1F(scattering_hist_data,1,"#A08144",set_logY,false,"","((Cl2-Cl1)/dis)-((Cl1-Cl0)/dis)","Events");
    // scattering_hist_data -> Draw("hist");
    ...
    // Characterize_Hist1F(track_candi_slope_data,1,"#A08144",set_logY,false,Form("U%i",study_chip_data),"Slope [tan(#theta)]","Events",X_label_less,Y_label_far);
    ...
    TString folder_direction_MC = "/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/Beamtest_data_Different_config/MC_run64_without_lead_plate_equals_to_run89_with_run89_slope_and_offset";
    ...
    double amount_of_alignment_MC = -2.83999e-01; // note : amount of alignment to all columns, the value is based on MC run64 (without lead plate, kind of MC run 89) column 10
    double slope_correction_MC = 4.32004e-03; // note : MC run64 (without lead plate, kind of MC run 89) track slope, from MC5
    ...
    // Characterize_Hist1F(Ntrack_extrapolation_pos_dist_MC,0,"#A08144",set_logY,false,"","Track pos @ sci. location [mm]","Events",X_label_less,Y_label_far);    
    // Ntrack_extrapolation_pos_dist_MC -> Draw("hist");
    // c1 -> Print(folder_direction_MC+"/MC_run89_track_extrapolation_pos_dist.pdf");
    ...
    // Characterize_Hist1F(residual_hist_MC,0,"#A08144",set_logY,false,Form("U%i",study_chip_data),"Residual [mm]","Events",X_label_less,Y_label_far);
    // residual_hist_MC -> Draw("hist");
    ...
    // TString plot_name = "Run89_AllColumn_comp_Ntrack_Nbin_"+std::to_string(Hist_nbins)+"_PosCut_"+Form("%.2f",extrapol_pos_cut_high)+"mm";
    ...
    //     TString plot_name = "Run89_U10_comp_ClusterSize_Nbin_"+std::to_string(Hist_nbins)+"_LayerID"+std::to_string(i);
    //     // TString plot_name = "run64_WithoutLeadPlate_EqualsToRun89_AllColumn_comp_Ntrack_Nbin_"+std::to_string(Hist_nbins)+"_PosCut_"+Form("%.2f",extrapol_pos_cut_high)+"mm";
    ...
    //     // binbin_uniform(cluster_size_dist_all_layers_data[i],bin_uniform_factor);
    //     // binbin_uniform(cluster_size_dist_all_layers_MC[i],bin_uniform_factor);
