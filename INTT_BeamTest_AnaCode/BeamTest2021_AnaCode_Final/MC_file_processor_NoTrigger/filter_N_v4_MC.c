...
void filter_N_v4_MC (TString file_name)
{
	//===================================option===========================================
	// TString file_name = "BeamData_20211210-2043_0";
	TString path_in = "/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/BeamTest2021_data_MC_file_plot_final/MC_file/MC_hinako/";
	//===================================option===========================================
