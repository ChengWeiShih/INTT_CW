...
void run52_MC_NoCamac_DUT_residual()
{
    int selection_level = 9;
    ...
    TH1F * residual_hist = plot_residual_narrow_publish( DUT_data_v2.middle_layer_residual, folder_direction, study_chip, selection_level );
