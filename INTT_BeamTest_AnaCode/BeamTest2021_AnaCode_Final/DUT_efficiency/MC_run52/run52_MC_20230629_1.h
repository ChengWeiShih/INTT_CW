...
// TString folder_direction = "/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/BeamTest2021_data_MC_file_plot_final/MC_file/MC_run52/folder_run52_MC_run_20230629_1";
TString folder_direction = "/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/BeamTest2021_data_MC_file_plot_final/MC_file/MC_run52/folder_run52_MC_run_20230629_1/scattering_l0l1_attempt";
...
int study_chip = 11;
double amount_of_alignment = -0.3072;
double slope_correction = 0.00156275; // note : to correct the slope distribution, easy to apply the cut
