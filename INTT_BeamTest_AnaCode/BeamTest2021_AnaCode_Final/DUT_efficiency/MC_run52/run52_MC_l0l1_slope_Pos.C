...
{    
    ...
    DUT_str DUT_data_v2 = efficiency_DUT_method_residual_test_2(cluster_reformat_str_vec,study_chip);

    TH2F * slope_pos = plot_angle_pos_2D(DUT_data_v2.l0_l1_slope_vec, DUT_data_v2.l0_l1_pos_vec,folder_direction,study_chip,selection_level);
