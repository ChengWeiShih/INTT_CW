...
// TString folder_direction = "/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/BeamTest2021_data_MC_file_plot_final/MC_file/MC_run52/folder_run52_MC_run_20230629_2";
TString folder_direction = "/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/BeamTest2021_data_MC_file_plot_final/MC_file/MC_run52/folder_run52_MC_run_20230629_2/scattering_l0l1_attempt";
...
int study_chip = 11;
double amount_of_alignment = -0.307157;
double slope_correction = 0.00157269; // note : to correct the slope distribution, easy to apply the cut
...
double pos_cut_scattering   = 2; // note : mm
double cluster_adc_value_requirement_scattering = 22.5;
double slope_correction_l0_l1 = 0.0;
