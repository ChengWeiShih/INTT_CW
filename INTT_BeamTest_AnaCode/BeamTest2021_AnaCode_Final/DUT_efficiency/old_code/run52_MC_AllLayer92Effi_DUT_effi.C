...
void run52_MC_AllLayer92Effi_DUT_effi ()
{
    // note : the setting pars
    TString folder_direction = "/Users/chengweishi/Downloads/BeamTest_2021/DUT_efficiency/run52_MC_AllLayer92Effi";
    TString file_name = "not_used"; // note : not used
    TString cluster_file_name = "cluster_information_offset-0.0000_adcinfo";
    int study_chip = 11;
