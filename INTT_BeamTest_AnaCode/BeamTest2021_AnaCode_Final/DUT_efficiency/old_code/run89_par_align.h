...
// todo : changed
TString folder_direction = "/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/DUT_efficiency/run89_data_NoCamac_align";
...
double slope_correction = 0.00474917; // note : to correct the slope distribution. 
