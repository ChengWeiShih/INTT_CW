...
// todo : changed
TString folder_direction = "/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/DUT_efficiency/run52_data_NoCamac_U9";
TString file_name = "not_used"; // note : not used
TString cluster_file_name = "cluster_information_offset-0.2629_adcinfo_NoCamac";
int study_chip = 9; 
...
// todo : changed
double slope_correction = 0.001923; // note : to correct the slope distribution. 
