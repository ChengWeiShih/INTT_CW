...
void run52_comp_test ()
{
    ...
    TFile * output_file = new TFile("/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/MC_data_residual_comp/run52_U8_data/DUT_residual_narrow_U8_test.root","RECREATE");
    hist -> Write("run52_U8");
