#include "run52_par_MC_residual.h"
...
void run52_MC_residual()
{
    ...
    TFile * output_file = new TFile("/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/MC_data_residual_comp/folder_e+_934MeV_L1offset_1M_filter_all_int_1000_chip_9/DUT_residual_narrow_U11_test.root","RECREATE");
    hist -> Write("run52_U11");
