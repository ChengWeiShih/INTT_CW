...
TString folder_direction = "/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/BeamTest2021_data_MC_file_plot_final/data_file/run89";

TString file_name = "not_used"; // note : not used
TString cluster_file_name = "cluster_information_offset-0.0000_adcinfo_NoCamac";
 

// note : official, Column 10
int study_chip = 10;
double amount_of_alignment = -0.2926;
double slope_correction = 0.00474917; // note : to correct the slope distribution, easy to apply the cut
...
double beam_spot_range[2] = {-9.6,2.2};
double effi_pos_legend_offset = 0.12;