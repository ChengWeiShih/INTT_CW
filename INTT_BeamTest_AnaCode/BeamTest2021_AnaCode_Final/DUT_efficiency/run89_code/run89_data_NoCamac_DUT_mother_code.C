...
void run52_data_NoCamac_DUT_slope()
{
    ...
    // plot_angle( align_DUT_data.good_combination_slope_hit3, align_DUT_data.good_combination_slope_hit2, folder_direction, study_chip, false );
    ...
    // TH1F * hist = plot_residual_narrow_publish( DUT_data_v2.middle_layer_residual, folder_direction, study_chip );

    // TFile * output_file = new TFile("/data4/chengwei/Geant4/INTT_simulation/G4/for_CW/DUT_efficiency/run52_new_alignment/DUT_residual_narrow_U8_pub.root","RECREATE");
    // hist -> Write("run52_U8");
