...
// note : official, Column 9
int study_chip = 9;
// double amount_of_alignment = -0.2651;
// double slope_correction = 0.XXXX; // note : to correct the slope distribution, easy to apply the cut, not know, not tested
