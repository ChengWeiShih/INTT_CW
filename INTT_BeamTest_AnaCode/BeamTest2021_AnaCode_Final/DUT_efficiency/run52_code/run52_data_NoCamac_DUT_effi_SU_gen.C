...
void run52_data_NoCamac_DUT_effi_SU_gen()
{
    ...
    {
        system("nohup root -l -b -q run52_SU_scan_file_generator.C\\(1\\)&>scan_log_residual.log&"); // note : residual
        cout<<"SU file generator, residual is submitted"<<endl;
        
        system("nohup root -l -b -q run52_SU_scan_file_generator.C\\(2\\)&>scan_log_slope.log&"); // note : slope
        cout<<"SU file generator, slope is submitted"<<endl;
        
        system("nohup root -l -b -q run52_SU_scan_file_generator.C\\(3\\)&>scan_log_edge.log&"); // note : edge_exclusion
