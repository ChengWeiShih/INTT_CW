  ...
  //  output_( output )
{
  ...
  analysisManager->CreateNtupleDColumn("track_X");
  analysisManager->CreateNtupleDColumn("track_Y");
  analysisManager->CreateNtupleDColumn("track_Z");
  ...
  analysisManager->CreateNtupleDColumn("step_edep");
  analysisManager->CreateNtupleDColumn("pre_X");
  analysisManager->CreateNtupleDColumn("pre_Y");
  analysisManager->CreateNtupleDColumn("pre_Z");
  analysisManager->CreateNtupleDColumn("post_X");
  analysisManager->CreateNtupleDColumn("post_Y");
  analysisManager->CreateNtupleDColumn("post_Z");

  analysisManager->CreateNtupleIColumn("pre_process");// note : to save the process name
  analysisManager->CreateNtupleIColumn("post_process");
  analysisManager->FinishNtuple();
  ...
  // note : in EDD, to save the position of each channel cell 
  // note : number 7
  analysisManager->CreateNtuple("chan_pos", "chan_pos");
  ...
  analysisManager->CreateNtupleDColumn( "cell_x"		);
  analysisManager->CreateNtupleDColumn( "cell_y"		);
  analysisManager->CreateNtupleDColumn( "cell_z"		);
  // analysisManager->FinishNtuple();
