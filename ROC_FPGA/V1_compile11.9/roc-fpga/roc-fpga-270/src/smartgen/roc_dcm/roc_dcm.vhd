...
architecture DEF_ARCH of roc_dcm is 
...
begin 
    ...
    Core : PLL
      generic map(VCOFREQUENCY => 188.000)
      ...
      port map(CLKA => CLKA, EXTFB => \GND\, POWERDOWN => 
        ...
        OBDIV1 => \GND\, OBDIV2 => \GND\, OBDIV3 => \GND\, OBDIV4
         => \GND\, OBMUX0 => \VCC\, OBMUX1 => \VCC\, OBMUX2 => 
...
-- MGNTIMER:F
-- MGNCMPL:T
-- DESDIR:C:/Users/curlywei/Documents/roc-fpga-270/src_old/smartgen\roc_dcm
-- GEN_BEHV_MODULE:F
