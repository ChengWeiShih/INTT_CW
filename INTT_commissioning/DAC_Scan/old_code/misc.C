...
void misc ()
{
    ...
    single_event.push_back( {1,  127, 3} );
    single_event.push_back( {14, 127, 4} );
    
    single_event.push_back( {16,  0, 3} );

    single_event.push_back( {13,  14, 7} );
    single_event.push_back( {13,  15, 7} );
    single_event.push_back( {13,  16, 7} );

    single_event.push_back( {13,  127, 1} );
    single_event.push_back( {26,  127, 1} );

    single_event.push_back( {26,  5, 4} );
