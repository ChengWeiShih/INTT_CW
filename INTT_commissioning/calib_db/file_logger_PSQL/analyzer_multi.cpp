...
{   
    ...
    analyzer * file_1 = new analyzer(DataIn_directory, Full_MapIn, DataOut_directory, ROC_index, file_name, threshold, ampl_cut, used_sigma, classify_base, output_basic, output_dead_channel_tree);
